package dev.jkiakumbo.paymentorchestrator.processorservice.config
...
class KafkaConfig {
    ...
    fun consumerFactory(): ConsumerFactory<String, String> {
        val props = mapOf(
            ...
            ConsumerConfig.GROUP_ID_CONFIG to "processor-service",
    ...
    @Bean
    fun processorDlqTopic(): NewTopic {
        return org.springframework.kafka.config.TopicBuilder.name("processor-service-dlq")
            .partitions(3)
            .replicas(1)
            .build()
    }
